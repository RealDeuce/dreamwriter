...
C772:2A7E  07                pop es
C772:2A7F  E8 5AFF           call C772:29DC   ; init display script table
C772:2A82  E8 B303           call C772:2E38   ; init app state variables
C772:2A85  E8 EECF           call C772:6476   ; init storage/drive state
C772:2A88  E8 A2C7           call C772:022D   ; -> interpreter (never returns)
```
...
C772:84EE  07                pop es
C772:84EF  3C 01             cmp al,1
C772:84F1  75 0B             jnz C772:84FE
...
```
