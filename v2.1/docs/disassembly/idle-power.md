...
; file 0x44961
C000:4961  83 3E 0D 68 00    cmp  word [0x680d],0
C000:4966  75 ...            jnz  no_retained_request
C000:4968  81 3E 09 68 92 19 cmp  word [0x6809],0x1992
...
C000:4970  F9                stc
C000:4971  C3                ret
```
...
C000:49FB  75 1E             jnz  power_event_C000_4A1B
C000:49FD  E8 61 FF          call retained_request_C000_4961
...
...
C000:4C49  C6 06 52 6D 00    mov  byte [0x6d52],0
C000:4C4E  C3                ret
