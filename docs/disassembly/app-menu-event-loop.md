...
| `0xF6` | `C688:ED1F` | `0x5559F` | Spell/Grammar Check front end; see [`wp-linguistic-tools.md`](wp-linguistic-tools.md#spell-and-grammar-check). |
...
| `0xF7` | `C688:D8AF` | `0x5412F` | Dictionary front end; see [`wp-linguistic-tools.md`](wp-linguistic-tools.md#dictionary-front-end). |
| `0xF5` | `C688:ED1A` | `0x5559A` | Forced diagnostic-monitor entry through `C688:01B0`; see [`early-app-helper.md`](early-app-helper.md). |
| `0xF8` | `C688:E274` | `0x54AF4` | Thesaurus front end; see [`wp-linguistic-tools.md`](wp-linguistic-tools.md#thesaurus-front-end). |

The three linguistic editor roots are expanded in
[`wp-linguistic-tools.md`](wp-linguistic-tools.md); the banked linguistic engine
behind `C688:936A` remains covered in [`../spell-engine.md`](../spell-engine.md).
...
No open app-loop tool roots remain queued here.
