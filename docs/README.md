...
| [`running-rom-card-binaries.md`](running-rom-card-binaries.md) | Practical workflow for running arbitrary `EROMCARD.X` binaries through OTHERS -> ROM CARD. |
| [`basic-eromcard.md`](basic-eromcard.md) | Comparative feasibility notes for wrapping the DreamWriter 325 BASIC interpreter as T400 `EROMCARD.X`; depends on a non-T400 source ROM. |
...
| [`hardware.md`](hardware.md) | Keyboard, LCD/framebuffer, I/O ports, serial, printer, PCMCIA, sound, RTC, power, and low RAM state. |
