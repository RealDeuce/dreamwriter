...
MACLNG:	MOV [MCLTAB], DX ;SAVE POINTER TO COMMAND TABLE
	...
	MOV	DX,0o0 ;PUSH DUMMY ENTRY TO MARK END OF STK
	PUSH	DX ;DUMMY ADDR
...
db 0o56 ;CS OVERRIDE
	...
	RCR	AL,0o1 ;MAKE IT A CHAR AGAIN
	MOV	CL,AL ;PUT IN [C]
	PUSH	CX
	PUSH	BX ;SAVE PTR INTO CMD TABLE
	CALL	FETCHR ;GET A CHAR
	MOV	DX,0o1 ;DEFAULT ARG=1
	JNZ	??L002
...
??L004:
	...
	JMP	VALSCN ;EAT THE "-"
VALSC2:
	MOV	DX,0o0 ;INITIAL VALUE OF ZERO
NUMLOP:
	CMP	AL,0o54 ;COMMA
	...
	JNZ	$+0o3
	RET ;YES, JUST RETURN
	CMP	AL,"9"+0o1 ;NOW SEE IF ITS A DIGIT
	JAE	DECFET ;IF NOT, BACK UP AND RETURN
	CMP	AL,"0"
	JB	DECFET
	MOV	BX,0o0 ;[HL] is accumulator
	MOV	CH,10 ;[HL]=[DE]*10
NUML01:	ADD	BX,DX
...
MCLXEQ:	CALL	SCNVAR ;SCAN VARIABLE NAME
	...
	PUSH	AX
	MOV	CL,0o2 ;MAKE SURE OF ROOM ON STACK
	CALL	GETSTK
	JMP	MCLNEW
NEGD:
