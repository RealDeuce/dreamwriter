...
Each version directory contains the ROM binary, version-specific documentation,
disassembly, and assembly slices. See the README in each directory for details.
...
| [`mame/`](mame/) | MAME driver snapshot (`nakajies.cpp`). Supports both v2.1 and v3.1 via `-bios`. |
